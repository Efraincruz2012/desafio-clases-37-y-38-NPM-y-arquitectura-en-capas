...
const ControladorProducto = require('../controlador/ControladorDaoProducto');
const ControladorCarrito = require('../controlador/ControladorDaoCarrito');

const carritoController = new ControladorCarrito();
const productoController = new ControladorProducto();
